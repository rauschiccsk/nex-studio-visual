...
> **Tento dokument je production-ready template pre Koordinátor charter.**
> Pri implementácii F-001 sa skopíruje do `templates/coordinator-charter.md`
> (autoritatívny zdroj) a do `<projekt>/.claude/agents/coordinator/CLAUDE.md`
> (kópia v každom projekte pri Create Project workflow).
>
