...
export interface paths {
    ...
    "/api/v1/dialogue/messages/{message_id}/approve": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Approve Message
         * @description Director approves a ``pending`` message → forwards to recipient
         ...
         *     fetch).
         */
        post: operations["approve_message_api_v1_dialogue_messages__message_id__approve_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/dialogue/messages/{message_id}/reject": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Reject Message
         * @description Director rejects ``pending`` — no claude call, audit trail only.
         */
        post: operations["reject_message_api_v1_dialogue_messages__message_id__reject_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/dialogue/sessions": {
        ...
        /** List Sessions */
        get: operations["list_sessions_api_v1_dialogue_sessions_get"];
        put?: never;
        /**
         * Create Session
         * @description Director starts a fresh Gate E session.
         *
         ...
         */
        post: operations["create_session_api_v1_dialogue_sessions_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/dialogue/sessions/{session_id}": {
        ...
        /** Get Session */
        get: operations["get_session_api_v1_dialogue_sessions__session_id__get"];
        put?: never;
        post?: never;
        /** End Session */
        delete: operations["end_session_api_v1_dialogue_sessions__session_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/api/v1/dialogue/sessions/{session_id}/customer-next-question": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Ask Customer to generate its next question per the coverage plan.
         *
         *     Synchronous — waits for claude to respond and persists Customer's
         *     question as a ``pending`` message in the same HTTP request.
         */
        post: operations["trigger_customer_next_question_api_v1_dialogue_sessions__session_id__customer_next_question_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/dialogue/sessions/{session_id}/director-inject": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Director Inject Message
         * @description Director sends their own message to the chosen recipient agent.
         *
         ...
         */
        post: operations["director_inject_message_api_v1_dialogue_sessions__session_id__director_inject_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * DialogueMessageRead
         * @description Single message in a Gate E dialogue (REST response).
         */
        DialogueMessageRead: {
            /**
             * Author
             * @enum {string}
             */
            author: "customer" | "designer" | "director";
            /** Content */
            content: string;
            /**
             * Created At
         ...
         * @description POST /dialogue/sessions body. Director starts a fresh Gate E
        ...
        /**
         * DialogueSessionRead
         * @description Session-level state (REST response).
         */
        DialogueSessionRead: {
            /**
             * Created At
            ...
            /** Terminated By */
            terminated_by: ("user" | "timeout" | "server_restart" | "coverage_complete") | null;
            /**
             * Updated At
             * Format: date-time
             */
         ...
         * @description Session with all its messages — used by GET /sessions/{id} for
        ...
        DialogueSessionWithMessages: {
            ...
            message_count: number;
            /** Messages */
            messages?: components["schemas"]["DialogueMessageRead"][];
            /** Project Slug */
            project_slug: string;
            /**
             * Status
         ...
         * @description POST /dialogue/sessions/{id}/director-inject body. Director can
...
export interface operations {
    ...
    approve_message_api_v1_dialogue_messages__message_id__approve_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DialogueMessageRead"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    reject_message_api_v1_dialogue_messages__message_id__reject_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_sessions_api_v1_dialogue_sessions_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DialogueSessionRead"][];
                };
            };
        };
    };
    create_session_api_v1_dialogue_sessions_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DialogueSessionCreate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_session_api_v1_dialogue_sessions__session_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DialogueSessionWithMessages"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    end_session_api_v1_dialogue_sessions__session_id__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    trigger_customer_next_question_api_v1_dialogue_sessions__session_id__customer_next_question_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    director_inject_message_api_v1_dialogue_sessions__session_id__director_inject_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DirectorInjectMessage"];
            };
        };
        responses: {
            /** @description Successful Response */
