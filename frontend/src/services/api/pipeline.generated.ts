...
export interface paths {
    ...
    "/api/v1/projects/{project_id}/reassign": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["reassign_project_api_v1_projects__project_id__reassign_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        DedoProposalCreate: {
            ...
            /**
             * Proposed Action
             * @description uprav | answer | ask | fast_fix | decide
             */
        ...
        /**
         * PipelineBoardRead
         * @description Vývoj board snapshot: current 5-phase state + the most recent messages (CR-V2-021).
         *
...
export interface operations {
    ...
    read_project_assignments_api_v1_projects__project_id__assignments_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    reassign_project_api_v1_projects__project_id__reassign_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
